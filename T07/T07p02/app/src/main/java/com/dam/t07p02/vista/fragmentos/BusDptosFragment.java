...
public class BusDptosFragment extends Fragment {
    ...
    private SwipeRefreshLayout srDptos;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        srDptos = v.findViewById(R.id.srDptos);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        srDptos.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                DptosViewModel dptosVM = ViewModelProviders.of(requireActivity()).get(DptosViewModel.class);
                dptosVM.getDptos();
                srDptos.setRefreshing(false);
            }
        });
    }
